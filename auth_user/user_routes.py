...
def update_own_profile(update_data: UpdateRole, db: db_dependency, current_user: User = Depends(get_current_user)): # type: ignore
...
def get_user_by_id(user_id: str, db: db_dependency, current_user: User = Depends(get_current_user)): # type: ignore
